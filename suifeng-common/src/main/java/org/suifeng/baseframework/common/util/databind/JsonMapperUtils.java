package org.suifeng.baseframework.common.util.databind;
...
public class JsonMapperUtils {
    ...
    public static JsonMapperUtils nonEmptyMapper() {
        return new JsonMapperUtils(Include.NON_EMPTY);
    }

    /**
     * 创建只输出初始值被改变的属性到Json字符串的Mapper, 最节约的存储方式，建议在内部接口中使用。
     */
    public static JsonMapperUtils nonDefaultMapper() {
        return new JsonMapperUtils(Include.NON_DEFAULT);
    }
